# -*- coding: utf-8 -*-
"""
Created on Thu Apr 10 10:28:13 2025
...
f, *tail = dlis.load("C:/Users/Theresa/OneDrive/PESQUISA/LabMeg_Exxon/PMP_BC_WELL_LOGGING/original_data/dlis_data/1FR__0001__SC_1FR__0001__SC.dlis")
f.describe() 
...
columns_to_extract = ['INDEX4920', 'CCER', 'FCNL', 'NCNL', 'CNST', 'NPHI', 'NPHS','NPHD', 'TEMP', 'DTEM', 'TENS', 'BIT', 'CALI', 'DPHI', 'RHOB','DRHO', 'PEF', 'QL', 'QS', 'BIT1', 'BIT2', 'CAS1', 'TSPD', 'CAS2', 'BHV', 'AHV', 'MIND', 'MAXD', 'RMIN', 'RMAX', 'BHVT', 'AHVT', 'GR'] #'RLN','RSN','SP','RLAT']
...
las_file.write('C:/Users/Theresa/OneDrive/PESQUISA/LabMeg_Exxon/PMP_BC_WELL_LOGGING/DLIS_to_LAS_stage1/1FR_1_SC.las')
